...
const logos = [
  "ELITE", "VOGUE", "GQ", "MAN", "LUXE", "STYLE", "PRIME", "ELEGANCE"
];
  ...
  return (
    <div className="py-12 bg-dark border-y border-white/5 overflow-hidden">
      <div className="container mx-auto px-6 mb-8 text-center">
        <span className="text-[9px] uppercase tracking-[0.4em] text-white/20 font-bold">Visto en publicaciones globales</span>
      </div>
