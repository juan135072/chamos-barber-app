...
import { ArrowRight, PlayCircle, Scissors } from "lucide-react";
...
export default function Hero() {
  ...
  const rotate3d = useTransform(scrollYProgress, [0, 1], [0, 15]);

  return (
    <section 
      ref={containerRef}
      className="relative min-h-screen flex items-start justify-center overflow-hidden bg-dark pt-56 pb-24"
    >
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          >
            ...
            <span className="text-gold text-xs font-black tracking-[0.6em] uppercase">Establecido 2011</span>
            <div className="h-[1px] w-8 bg-gold/50" />
          </motion.div>
          
          <h1 className="text-6xl md:text-[110px] font-black leading-[0.8] tracking-tighter uppercase mb-12">
            Domina tu<br/>
            <span className="text-gold italic">Estilo</span><br/>
            <span className="outline-text">Supremo</span>
          </h1>
          
          <p className="text-white/60 text-lg md:text-xl max-w-2xl mx-auto mb-16 leading-relaxed font-medium tracking-wide">
            Una experiencia de cuidado inmersiva donde la precisión quirúrgica se encuentra con el arte clásico. Redefinimos el estándar del caballero moderno.
          </p>
          ...
          <div className="mt-24 flex flex-wrap justify-center gap-12 md:gap-24 border-t border-white/5 pt-16">
            {[
              ...
              { label: "Premios Mundiales", value: "24" },
              { label: "Años de Maestría", value: "15" }
            ].map((stat) => (
