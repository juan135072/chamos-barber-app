    ...
    <div className="fade-in">
      ...
      <div className="flex gap-2 mb-6">
        <button
          ...
          className={`flex-1 py-2.5 px-4 rounded-lg text-sm font-medium transition-all flex items-center justify-center gap-2 ${activeView === 'atencion' ? 'btn-minimal-primary' : 'btn-minimal-ghost'
            }`}
        >
        ...
        <button
          ...
          className={`flex-1 py-2.5 px-4 rounded-lg text-sm font-medium transition-all flex items-center justify-center gap-2 ${activeView === 'bloqueados' ? 'btn-minimal-primary' : 'btn-minimal-ghost'
            }`}
        >
      ...
      {showCrearBloqueoModal && (
        <CrearBloqueoModal
          isOpen={showCrearBloqueoModal}
          onClose={() => setShowCrearBloqueoModal(false)}
          onSuccess={() => {
            setShowCrearBloqueoModal(false)
            loadBloqueosDelDia()
            loadHorariosBloqueados()
          }}
          barberoId={selectedBarbero}
