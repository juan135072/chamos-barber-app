  ...
  return (
    ...
    >
      ...
      <div className="preloader-content">
        ...
        {/* Nuevo Logo tipográfico construido con CSS */}
        <div className="logo-section">
          <div className="logo-glow" />
          <div className="logo-flex">
            <div className="logo-icon-box">
              <Scissors className="logo-icon" strokeWidth={2.5} />
            </div>
            <h1 className="brand-name">
              CHAMOS<span className="text-gold">.</span>
            </h1>
          </div>
          <p className="tagline">EST. 2021</p>
        </div>
      ...
      <style jsx>{`
        ...
        .logo-icon-box {
          width: 56px;
          height: 56px;
          background-color: #C5A059; /* Nuevo color dorado */
          border-radius: 12px;
          display: flex;
          align-items: center;
          justify-content: center;
