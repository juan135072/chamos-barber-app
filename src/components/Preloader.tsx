    ...
    >
      ...
      <style jsx>{`
        ...
        .logo-image {
          position: relative;
          z-index: 1;
          /* Adaptación de color para que el PNG amarillo se acerque al dorado Inspirar */
          filter: drop-shadow(0 0 20px rgba(197, 160, 89, 0.4)) sepia(0.3) hue-rotate(-5deg) saturate(0.8) brightness(0.95);
          animation: logoRotate 20s linear infinite;
        }

        @keyframes logoRotate {
          from {
            filter: drop-shadow(0 0 20px rgba(197, 160, 89, 0.4)) sepia(0.3) hue-rotate(-5deg) saturate(0.8) brightness(0.95) hue-rotate(0deg);
          }
          to {
            filter: drop-shadow(0 0 20px rgba(197, 160, 89, 0.4)) sepia(0.3) hue-rotate(-5deg) saturate(0.8) brightness(0.95) hue-rotate(360deg);
          }
        }
