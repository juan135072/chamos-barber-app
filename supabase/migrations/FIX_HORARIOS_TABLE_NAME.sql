-- ===================================================================
-- MIGRACIÓN: Fix Horarios Disponibles - Tabla Correcta y Timezone
-- ===================================================================
-- Propósito: 
-- 1. Actualizar la función para usar la tabla correcta 'horarios_atencion' (no 'horarios_trabajo')
-- 2. Usar la zona horaria de Chile al comparar fechas y horas.
-- 3. Usar SECURITY DEFINER para evitar problemas de RLS con usuarios anónimos.
-- ===================================================================
...
LANGUAGE plpgsql
SECURITY DEFINER -- Ejecutar con permisos de creador para evitar problemas de RLS
AS $$
DECLARE
...
BEGIN
  ...
  horarios_trabajo AS (
    ...
    -- CORRECCIÓN: Usar tabla 'horarios_atencion'
    SELECT 
      ht.hora_inicio,
      ht.hora_fin
